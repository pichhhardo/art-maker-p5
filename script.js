...
// You can also "comment out" lines of code temporarily to keep old versions of code around,
// without having the computer actual run the code. 
// For example, here's some broken code saved inside some comments:
// console.log(blablah);
// console.log(stuff in here);

// **Important tip:**
// You can "comment out" a bunch of code all at once by selecting multiple lines of code and then pressing `Ctrl + /` on Windows or `Cmd + /` on Mac. You can repeat the process to *uncomment* lines of code too.
